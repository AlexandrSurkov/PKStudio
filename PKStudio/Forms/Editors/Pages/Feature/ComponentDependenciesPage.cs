...
{
    public partial class ComponentDependenciesPage : FeaturePageBase
    {
        public ComponentDependenciesPage(FeatureWrapper Feat)
            : base(Feat)
        {
            InitializeComponent();
        ...
        public override string NodeName
        {
            get
            {
                return Strings.ComponentDependencies;
            }
        }
        public override bool OnApplyChanges()
        {
            ...
            //DepsInfoRTB.Clear();
            //Feat.ComponentDependencies.Clear();
            ...
            //        if (l != null)
            //        {
            //            Feat.ComponentDependencies.Add(ComponentWrapper.GetComponentWrapper(l));
            //        }
            //    }
            ...
            //        if (lc != null)
            //        {
            //            Feat.ComponentDependencies.Add(ComponentWrapper.GetComponentWrapper(lc));
            //        }
            //    }
            //}
        ...
        {
            _treeView.SetModel(InventoryBrowserModel.GetModel(this.Feat.ComponentDependencies), false);
            //DepsListView.Items.Clear();
            //foreach (ComponentWrapper dep in this.Feat.ComponentDependencies)
            //{
