...
namespace PKStudio.Tools.uVisionGenerator.Classes.uvProjectClasses
{
    ...
    {
        public ADSCCFLG_TYPE() { }

        public ADSCCFLG_TYPE(ADSCCFLG_TYPE basetype)
        {

            this._ARM_Thumb_Interworking = basetype.ARM_Thumb_Interworking;
            this._Optimisation = basetype.Optimisation;
            this._Optimize_for_time = basetype.Optimize_for_time;
            this._Split_Load_and_Store_Multiple = basetype.Split_Load_and_Store_Multiple;
            this._One_EFL_Section_per_Function = basetype.One_EFL_Section_per_Function;
            this._Strict_ANSI_C = basetype.Strict_ANSI_C;
            this._Enum_Container_always_int = basetype.Enum_Container_always_int;
            this._Plain_Char_is_Signed = basetype.Plain_Char_is_Signed;
            this._ReadOnly_Position_Independent = basetype.ReadOnly_Position_Independent;
            this._ReadWrite_Position_Independent = basetype.ReadWrite_Position_Independent;
            this._Warnings = basetype.Warnings;
            this._Thumb_Mode = basetype.Thumb_Mode;
        }

        public ADSCCFLG_TYPE(string paramstr)
        {

            string[] strs = paramstr.Split(',');

            #region byte 1
            byte bt = byte.Parse(strs[0]);

            switch (bt & 0x03)
            {
                case 0x00:
                    this._ARM_Thumb_Interworking = THREE_STATE_BOOL.DISABLED;
                    break;
                case 0x01:
                    this._ARM_Thumb_Interworking = THREE_STATE_BOOL.ENABLED;
                    break;
                case 0x02:
                    this._ARM_Thumb_Interworking = THREE_STATE_BOOL.DEFAULT;
                    break;
            }
            ...
            {
                case 0x00:
                    this._Optimisation = OPTIMIZATION.Default;
                    break;
                case 0x04:
                    this._Optimisation = OPTIMIZATION.Level0;
                    break;
                case 0x08:
                    this._Optimisation = OPTIMIZATION.Level1;
                    break;
                case 0x0C:
                    this._Optimisation = OPTIMIZATION.Level2;
                    break;
                case 0x10:
                    this._Optimisation = OPTIMIZATION.Level3;
                    break;
            }
            #endregion

            #region byte 2
            bt = byte.Parse(strs[1]);

            switch (bt & 0x06)
            {
                case 0x00:
                    this._Optimize_for_time = THREE_STATE_BOOL.DISABLED;
                    break;
                case 0x02:
                    this._Optimize_for_time = THREE_STATE_BOOL.ENABLED;
                    break;
                case 0x04:
                    this._Optimize_for_time = THREE_STATE_BOOL.DEFAULT;
                    break;
            }
            ...
            {
                case 0x00:
                    this._Split_Load_and_Store_Multiple = THREE_STATE_BOOL.DISABLED;
                    break;
                case 0x08:
                    this._Split_Load_and_Store_Multiple = THREE_STATE_BOOL.ENABLED;
                    break;
                case 0x10:
                    this._Split_Load_and_Store_Multiple = THREE_STATE_BOOL.DEFAULT;
                    break;
            }
            ...
            {
                case 0x00:
                    this._One_EFL_Section_per_Function = THREE_STATE_BOOL.DISABLED;
                    break;
                case 0x20:
                    this._One_EFL_Section_per_Function = THREE_STATE_BOOL.ENABLED;
                    break;
                case 0x40:
                    this._One_EFL_Section_per_Function = THREE_STATE_BOOL.DEFAULT;
                    break;
            }
            ...
            {
                case 0x00:
                    this._Strict_ANSI_C = THREE_STATE_BOOL.DISABLED;
                    break;
                case 0x80:
                    this._Strict_ANSI_C = THREE_STATE_BOOL.ENABLED;
                    break;
            }
            #endregion

            #region byte 3
            bt = byte.Parse(strs[2]);

            switch (bt & 0x81)
            {
                case 0x01:
                    this._Strict_ANSI_C = THREE_STATE_BOOL.DEFAULT;
                    break;
            }
            ...
            {
                case 0x00:
                    this._Enum_Container_always_int = THREE_STATE_BOOL.DISABLED;
                    break;
                case 0x02:
                    this._Enum_Container_always_int = THREE_STATE_BOOL.ENABLED;
                    break;
                case 0x04:
                    this._Enum_Container_always_int = THREE_STATE_BOOL.DEFAULT;
                    break;
            }
            ...
            {
                case 0x00:
                    this._Plain_Char_is_Signed = THREE_STATE_BOOL.DISABLED;
                    break;
                case 0x08:
                    this._Plain_Char_is_Signed = THREE_STATE_BOOL.ENABLED;
                    break;
                case 0x10:
                    this._Plain_Char_is_Signed = THREE_STATE_BOOL.DEFAULT;
                    break;
            }
            ...
            {
                case 0x00:
                    this._ReadOnly_Position_Independent = THREE_STATE_BOOL.DISABLED;
                    break;
                case 0x20:
                    this._ReadOnly_Position_Independent = THREE_STATE_BOOL.ENABLED;
                    break;
                case 0x40:
                    this._ReadOnly_Position_Independent = THREE_STATE_BOOL.DEFAULT;
                    break;
            }
            ...
            bt = byte.Parse(strs[3]);

            switch (bt & 0x81)
            {
                case 0x01:
                    this._ReadWrite_Position_Independent = THREE_STATE_BOOL.DEFAULT;
                    break;
            }
            ...
            {
                case 0x00:
                    this._Warnings = WARNINGS.Unspecified;
                    break;
                case 0x02:
                    this._Warnings = WARNINGS.NoWarnings;
                    break;
                case 0x04:
                    this._Warnings = WARNINGS.AllWarnings;
                    break;
            }
            ...
            {
                case 0x00:
                    this._Thumb_Mode = THREE_STATE_BOOL.DISABLED;
                    break;
                case 0x10:
                    this._Thumb_Mode = THREE_STATE_BOOL.ENABLED;
                    break;
                case 0x20:
                    this._Thumb_Mode = THREE_STATE_BOOL.DEFAULT;
                    break;
            }
            #endregion
        }
    ...
    public class RUN_USER_TYPE
    {
        ...
        public RUN_USER_TYPE(RUN_USER_TYPE basetype)
        {
            Command = basetype.Command;
            Run = basetype.Run;
        }
    ...
    public class TargetOptions
    {
        ...
        public TargetOptions(TargetOptions DefaultOptions)
        {
            this.ToolType = DefaultOptions.ToolType;
            this.Device = DefaultOptions.Device;
            this.Vendor = DefaultOptions.Vendor;
            this.Cpu = DefaultOptions.Cpu;
            this.FlashUt = DefaultOptions.FlashUt;
            this.StupF = DefaultOptions.StupF;
            this.FlashDR = DefaultOptions.FlashDR;
            this.DevID = DefaultOptions.DevID;
            this.Rgf = DefaultOptions.Rgf;
            this.Mem = DefaultOptions.Mem;
            this.C = DefaultOptions.C;
            this.A = DefaultOptions.A;
            this.RL = DefaultOptions.RL;
            this.OH = DefaultOptions.OH;
            this.DBC_IFX = DefaultOptions.DBC_IFX;
            this.DBC_CMS = DefaultOptions.DBC_CMS;
            this.DBC_AMS = DefaultOptions.DBC_AMS;
            this.DBC_LMS = DefaultOptions.DBC_LMS;
            this.UseEnv = DefaultOptions.UseEnv;
            this.EnvBin = DefaultOptions.EnvBin;
            this.EnvInc = DefaultOptions.EnvInc;
            this.EnvLib = DefaultOptions.EnvLib;
            this.EnvReg = DefaultOptions.EnvReg;
            this.OrgReg = DefaultOptions.OrgReg;
            this.TgStat = DefaultOptions.TgStat;
            this.OutDir = DefaultOptions.OutDir;
            this.OutName = DefaultOptions.OutName;
            this.GenApp = DefaultOptions.GenApp;
            this.GenLib = DefaultOptions.GenLib;
            this.GenHex = DefaultOptions.GenHex;
            this.Debug = DefaultOptions.Debug;
            this.Browse = DefaultOptions.Browse;
            this.LstDir = DefaultOptions.LstDir;
            this.HexSel = DefaultOptions.HexSel;
            this.MG32K = DefaultOptions.MG32K;
            this.TGMORE = DefaultOptions.TGMORE;
            this.RunUsr_0 = new RUN_USER_TYPE(DefaultOptions.RunUsr_0);
            this.RunUsr_1 = new RUN_USER_TYPE(DefaultOptions.RunUsr_1);
            this.BrunUsr_0 = new RUN_USER_TYPE(DefaultOptions.BrunUsr_0);
            this.BrunUsr_1 = new RUN_USER_TYPE(DefaultOptions.BrunUsr_1);
            this.CrunUsr_0 = new RUN_USER_TYPE(DefaultOptions.CrunUsr_0);
            this.CrunUsr_1 = new RUN_USER_TYPE(DefaultOptions.CrunUsr_1);
            this.SVCSID = DefaultOptions.SVCSID;
            this.GLFLAGS = DefaultOptions.GLFLAGS;
            this.ADSFLGA = DefaultOptions.ADSFLGA;
            this.ACPUTYP = DefaultOptions.ACPUTYP;
            this.RVDEV = DefaultOptions.RVDEV;
            this.ADSTFLGA = DefaultOptions.ADSTFLGA;
            this.OCMADSOCM = DefaultOptions.OCMADSOCM;
            this.OCMADSIRAM = DefaultOptions.OCMADSIRAM;
            this.OCMADSIROM = DefaultOptions.OCMADSIROM;
            this.OCMADSXRAM = DefaultOptions.OCMADSXRAM;
            this.OCR_RVCT = DefaultOptions.OCR_RVCT;
            this.RV_STAVEC = DefaultOptions.RV_STAVEC;
            this.ADSCCFLG = new ADSCCFLG_TYPE(DefaultOptions.ADSCCFLG);
            this._ADSCMISC = new List<string>(DefaultOptions.ADSCMISC);
            this._ADSCDEFN = new List<string>(DefaultOptions.ADSCDEFN);
            this._ADSCUDEF = new List<string>(DefaultOptions.ADSCUDEF);
            this._ADSCINCD = new List<string>(DefaultOptions.ADSCINCD);
            this.ADSASFLG = DefaultOptions.ADSASFLG;
            this._ADSAMISC = new List<string>(DefaultOptions.ADSAMISC);
            this._ADSADEFN = new List<string>(DefaultOptions.ADSADEFN);
            this._ADSAUDEF = new List<string>(DefaultOptions.ADSAUDEF);
            this._ADSAINCD = new List<string>(DefaultOptions.ADSAINCD);
            this.PropFld = DefaultOptions.PropFld;
            this.IncBld = DefaultOptions.IncBld;
            this.AlwaysBuild = DefaultOptions.AlwaysBuild;
            this.GenAsm = DefaultOptions.GenAsm;
            this.AsmAsm = DefaultOptions.AsmAsm;
            this.PublicsOnly = DefaultOptions.PublicsOnly;
            this.StopCode = DefaultOptions.StopCode;
            this._CustArgs = new List<string>(DefaultOptions.CustArgs);
            this._LibMods = new List<string>(DefaultOptions.LibMods);
            this.ADSLDFG = DefaultOptions.ADSLDFG;
            this.ADSLDTA = DefaultOptions.ADSLDTA;
            this.ADSLDDA = DefaultOptions.ADSLDDA;
            this.ADSLDSC = DefaultOptions.ADSLDSC;
            this.ADSLDIB = DefaultOptions.ADSLDIB;
            this.ADSLDIC = DefaultOptions.ADSLDIC;
            this.ADSLDMC = new List<string>(DefaultOptions.ADSLDMC);
            this.ADSLDIF = DefaultOptions.ADSLDIF;
            this.ADSLDDW = DefaultOptions.ADSLDDW;
            this.OPTDL = DefaultOptions.OPTDL;
            this.OPTDBG = DefaultOptions.OPTDBG;
            this.FLASH1 = DefaultOptions.FLASH1;
            this.FLASH2 = DefaultOptions.FLASH2;
            this.FLASH3 = DefaultOptions.FLASH3;
            this.FLASH4 = DefaultOptions.FLASH4;
        }
        ...
        /// Tool Type
        /// </summary>
        public TOOL_TYPE ToolType { get { return this.tooltype; } set { this.tooltype = value; } }
        ...
        public void SerializeXLM(string path)
        {
            XmlSerializer serializer = new XmlSerializer(typeof(TargetOptions));
        ...
        public static TargetOptions DesirializeXLM(string path)
        {
            XmlSerializer serializer = new XmlSerializer(typeof(TargetOptions));
            TargetOptions result = null;
            using (FileStream fs = new FileStream(path, FileMode.OpenOrCreate))
            {
                TextReader reader = new StreamReader(fs);
                result = (TargetOptions)serializer.Deserialize(reader);
            }
